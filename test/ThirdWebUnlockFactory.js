...
const { PublicLockV11 } = require("@unlock-protocol/contracts")

describe("ThirdWebUnlockFactory", function () {
  ...
  it('should work', async () => {
    ...
    const implementation = await unlockContract.publicLockAddress()
    ...
    const tx = await thirdWebUnlockFactory.deployProxyByImplementation(implementation, params, ethers.utils.formatBytes32String('hello'))
